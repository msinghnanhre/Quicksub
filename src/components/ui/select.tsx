...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-[38px] w-full items-center justify-between rounded-sm border border-input bg-surface px-3.5 text-[13.5px] text-ink",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        "px-2 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-ink-subtle",
        className
      )}
      {...props}
    />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center rounded-xs py-1.5 pl-2 pr-8 text-[13.5px] text-ink-2 outline-none",
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <ChevronUp className="size-3.5 text-ink-subtle" />
    </SelectPrimitive.ScrollUpButton>
  );
}
